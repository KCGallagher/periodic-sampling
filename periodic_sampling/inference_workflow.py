...
filename = f"inference_T_{bias_method}_{time_steps}_N0_{N_0}_R0diff_{R0_diff}_It_{step_num}_seeds_{seed+1}.csv"
output1.to_csv('data/outputs/stepped_R/multichain/variable_sampling_rate/' + filename)
